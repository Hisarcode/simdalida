    ...
    <div class="card-body p-0">
        ...
        <div class="row">
            <div class="col-lg-5 d-none d-lg-block">
                <img src="backend/img/login.PNG" alt="">
            </div>
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="inisiator_id"
                                class="col-md-4 col-form-label text-md-right">{{ __('Inisiator') }}</label>

                            <div class="col-md-6">
                                <select name="inisiator_id" id="inisiator_id"
                                    class="form-control @error('name') is-invalid @enderror" required
                                    autocomplete="name" autofocus>
                                    <option value="">Pilih Inisiator</option>
                                    @foreach ($inisiators as $inisiator)
                                    <option value="{{ $inisiator->id }}">{{ $inisiator->inisiator }}</option>
                                    @endforeach
                                </select>
                                @error('inisiator_id')
