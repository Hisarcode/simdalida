    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('innovation-report.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="innovation_sk_file"> <b>Upload SK Bupati:</b> <input type="file"
                            name="innovation_sk_file" placeholder="SK bupati" required></label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label>
                        <input type="radio" name="innovation_formats" id="innovation_formats" value="Pelayanan Publik"
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="problem" id="problem" class="form-control"
                        placeholder="Isikan masalah yang dihadapi" required
                ...
                <div class="form-group">
                    ...
                    <label for="complain_innovation_file"> <b>Upload dokumen rekapitulasi pengaduan: </b><input
                            type="file" name="complain_innovation_file" placeholder="SK bupati"></label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label for="complain_improvement_file"> <b>Upload dokumen penyelesaian pengaduan:</b> <input
                            type="file" name="complain_improvement_file" placeholder="SK bupati"></label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="achievement_goal_problem" id="achievement_goal_problem"
                        class="form-control" placeholder="Isikan kendala pencapaian tujuan inovasi daerah" required
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="achievement_result_problem" id="achievement_result_problem"
                        class="form-control" placeholder="Isikan kendala pencapaian hasil inovasi daerah" required
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="video_innovation"
                        placeholder="Masukkan link youtube dari video inovasi" value="{{ old('video_innovation') }}"
                        required autocomplete="off">
                </div>
