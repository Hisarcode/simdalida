        ...
        <div class="card-body">
            <form action="{{ route('innovation-report.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="problem" placeholder="Isikan masalah yg dihadapi" value="{{ old('problem') }}" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="solution">Solusi terhadap Permasalahan/kendala yg dihadapi</label>
                    <input type="text" class="form-control" name="solution" placeholder="Isikan solusi dari permasalahan" value="{{ old('solution') }}" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="improvement">Tindaklanjut terhadap permasalahan</label>
                    <input type="text" class="form-control" name="improvement" placeholder="Isikan Tindaklanjut terhadap permasalahan" value="{{ old('improvement') }}" required autocomplete="off">
                </div>


                <div class="form-group">
                    <label for="complain_innovation_total">Jumlah pengaduan/saran terkait inovasi</label>
                    <input type="text" class="form-control" name="complain_innovation_total" placeholder="Isikan Jumlah pengaduan/saran terkait inovasi" value="{{ old('complain_innovation_total') }}" required autocomplete="off">

                    <label for="complain_innovation_file"> Upload dokumen rekapitulasi pengaduan:  <input type="file" name="complain_innovation_file" placeholder="SK bupati" ></label> 
                </div>

                <div class="form-group">
                    <label for="complain_improvement_total">Jumlah pengaduan/saran yg sudah ditindaklanjuti</label>
                    <input type="text" class="form-control" name="complain_improvement_total" placeholder="Isikan Jumlah pengaduan/saran terkait inovasi" value="{{ old('complain_improvement_total') }}" required autocomplete="off">

                    <label for="complain_improvement_file"> Upload dokumen penyelesaian pengaduan:  <input type="file" name="complain_improvement_file" placeholder="SK bupati" ></label> 
                </div>

                <div class="form-group">
                    <label for="achievement_goal_level">Tingkat Capaian Tujuan Inovasi Daerah</label>
                    <input type="text" class="form-control" name="achievement_goal_level" placeholder="Isikan Jumlah pengaduan/saran terkait inovasi" value="{{ old('achievement_goal_level') }}" required autocomplete="off">

                    <label for="achievement_goal_level_file"> Upload dokumen pendukung:  <input type="file" name="achievement_goal_level_file" ></label> 
                </div>

                <div class="form-group">
                    <label for="achievement_goal_problem">Kendala Pencapaian tujuan inovasi daerah</label>
                    <input type="text" class="form-control" name="achievement_goal_problem" placeholder="Isikan Kendala Pencapaian tujuan inovasi daerah" value="{{ old('achievement_goal_problem') }}" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="benefit_level">Tingkat Kemanfaatan Inovasi Daerah</label>
                    <input type="text" class="form-control" name="benefit_level" placeholder="Isikan Kemanfaatan Inovasi Daerah" value="{{ old('benefit_level') }}" required autocomplete="off">

                    <label for="benefit_level_file"> Upload dokumen pendukung:  <input type="file" name="benefit_level_file" ></label> 
                </div>

                <div class="form-group">
                    <label for="achievement_result_level">Tingkat Capaian Hasil Inovasi Daerah</label>
                    <input type="text" class="form-control" name="achievement_result_level" placeholder="Isikan Kemanfaatan Inovasi Daerah" value="{{ old('achievement_result_level') }}" required autocomplete="off">

                    <label for="achievement_result_level_file"> Upload dokumen pendukung:  <input type="file" name="achievement_result_level_file" ></label> 
                </div>

                <div class="form-group">
                    <label for="achievement_result_problem">Kendala Pencapaian hasil inovasi daerah</label>
                    <input type="text" class="form-control" name="achievement_result_problem" placeholder="Isikan Kendala Pencapaian hasil inovasi daerah" value="{{ old('achievement_result_problem') }}" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="innovation_strategy">Strategi Pelaksanaan Inovasi</label>
                    <input type="text" class="form-control" name="innovation_strategy" placeholder="Isikan Strategi Pelaksanaan Inovasi value="{{ old('innovation_strategy') }}" required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="video_innovation">Video Inovasi Daerah</label>
                    <input type="file" class="form-control" name="video_innovation" placeholder="video_innovation" class="form-control">
                </div>
