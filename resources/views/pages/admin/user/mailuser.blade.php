            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Promote Operator</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                Selamat anda berhasil menjadi operator di website Simdalida, Silahkan kunjungi link <a href="http://127.0.0.1:8000/admin">Simdalida Admin</a> untuk mengakses halaman operator dengan login menggunakan username serta password berdasarkan register sebelumnya. Jika lupa dengan username dan password bisa langsung hubungi admin Simdalida.
                              </td>
                          </tr>
                        </table>
                        <div>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>TerimaKasih</p>
                              <p>Email ini dikirimkan secara otomatis oleh sistem, kami tidak melakukan pengecakan email yang dikirimkan ke email ini. Jika ada pertanyaan, silahkan kunjungi website simdalida dan bertanya lewat layanan Hubungi Kami.</p>
                            </td>
                          </tr>
                        </table>
                      </td>
